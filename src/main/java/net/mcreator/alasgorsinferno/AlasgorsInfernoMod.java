 ...
 *
 */
package net.mcreator.alasgorsinferno;
...
@Mod("alasgors_inferno")
public class AlasgorsInfernoMod {
	public static final Logger LOGGER = LogManager.getLogger(AlasgorsInfernoMod.class);
	public static final String MODID = "alasgors_inferno";

	public AlasgorsInfernoMod() {
